...
RUN apt-get update ; apt-get install -y moosefs-cgi moosefs-cgiserv nano ; rm -rf /var/lib/apt/lists/* && mv /etc/mfs/mfsexports.cfg.sample /etc/mfs/mfsexports.cfg ; mv /etc/mfs/mfsmaster.cfg.sample /etc/mfs/mfsmaster.cfg ;
